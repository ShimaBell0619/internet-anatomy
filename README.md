...
- **Story** — the default interactive protocol theater. Stay in one scene, choose the next meaningful DNS actor, and learn immediately what happened and why the responsibility handoff continues.
...
> Queried hostnames are sent from your browser to Google Public DNS. Story and Compare are explanatory reconstructions from observed DNS data. Story handoff arrows and Auto progression are not packet captures, measured hop timing, or reproductions of your operating system's resolver path.
